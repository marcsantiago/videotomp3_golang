...
<p><b>Known Windows Bug</b></p>
<p>
  The folder name you create must not have spaces in it, please use underscores otherwise the songs will not move to specified folder. They will just stay in the parent directory.  Correct --> /User/Desktop/my_mp3s Incorrect --> /User/Desktop/My Mp3
</p>
